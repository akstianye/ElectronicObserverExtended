...
namespace ElectronicObserver.Utility
{
	...
	public static class SoftwareInformation
	{
		...
		/// </summary>
		public static string VersionJapanese => SoftwareNameJapanese + "四六型改二";


		/// <summary>
		/// バージョン(英語)
		/// </summary>
		public static string VersionEnglish => "4.6.2";
		...
		/// 更新日時
		/// </summary>
		public static DateTime UpdateTime => DateTimeHelper.CSVStringToTime("2020/09/21 00:00:00");
